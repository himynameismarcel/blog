...
* **Deployment:**\
Deployment id, among others, discussed in [blogdown: Creating Websites with RMarkdown](https://bookdown.org/yihui/blogdown/) itself. While for jekyll the recommended solution was to use github-pages and a similar approach is also viable for blogdown, the authors recommend using [Netlify](https://app.netlify.com) for continuous deployment. I have made use of this option myself and was able to deploy the website (which you first have to push to your remote github repository) worked like a charm.
