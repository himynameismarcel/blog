...
* As a complementary resource a great article by Storybench on [How to build a website with Blogdown in R](https://www.storybench.org/how-to-build-a-website-with-blogdown-in-r/).
...
Finally, `YOUR-CDN-LIN` has to be replaced with the link to your preferred CDN host of MathJax, .e.g `cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5`.
